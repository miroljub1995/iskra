...
)
{
    public async Task GenerateAsync(CancellationToken cancellationToken = default)
    {
        ...
        foreach (var desc in genTypeDescriptors.Descriptors)
        {
            ...
            initStatements.Add($$"""
                                 Iskra.JSCore.JSObjectProxyFactory.AddConstructorFromProp(global::System.Runtime.InteropServices.JavaScript.JSHost.GlobalThis, "{{desc.Name}}", obj => new {{desc.Name}}(obj) );
                                 """
            );
        }
