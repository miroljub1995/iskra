...
public class Element : Node
{
    ...
    public void After(params IReadOnlyList<OneOf<Node, string>> nodes) => throw new();
    public void Animate(string el) => throw new();

    // public void Animate() => throw new();

    public void Append(params IReadOnlyList<OneOf<Node, string>> nodes) => throw new();

    public ShadowRoot AttachShadow(ElementAttachShadowOptions options) => throw new();

    public void Before(params IReadOnlyList<OneOf<Node, string>> nodes) => throw new();
    ...
    public void Prepend(params IReadOnlyList<OneOf<Node, string>> nodes) => throw new();
    ...
    public void ReplaceChildren(params IReadOnlyList<OneOf<Node, string>> nodes) => throw new();

    public void ReplaceWith(params IReadOnlyList<OneOf<Node, string>> nodes) => throw new();
