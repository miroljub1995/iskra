...
)
{
    public string Generate(NamespaceType input)
    {
        ...
        var content = $$"""
                        ...
                        public partial class {{className}}: global::Iskra.JSCore.JSObjectProxy
                        {
                            [global::System.Runtime.Versioning.SupportedOSPlatform("browser")]
                            public {{className}}(global::System.Runtime.InteropServices.JavaScript.JSObject obj): base(obj)
                            {
                            }
